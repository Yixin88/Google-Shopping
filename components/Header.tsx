      ...
      <div className="w-full md:max-w-2xl">
        <form action={formData => {
          ...
          <div className="grid grid-cols-2 gap-2 p-4 md:grid-cols-4 max-w-lg md:max-w-none mx-auto item-center">
            <SearchSelect onValueChange={value => setPages(value)} className="min-w-4" placeholder="# of pages">
              {[...Array(100)].map((_, i) => (
            ...
            <Select onValueChange={value => setSortBy(value)} className="min-w-4" placeholder="Sort">
